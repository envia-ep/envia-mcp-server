...
const FlatSenderSchema = z.object({
    ...
    sender_company_name: z.string().nullable().optional(),
    sender_email: z.string().nullable().optional(),
    sender_phone: z.string().nullable().optional(),
    sender_street: z.string().nullable().optional(),
    sender_number: z.string().nullable().optional(),
    sender_interior_number: z.string().nullable().optional(),
    sender_district: z.string().nullable().optional(),
    sender_city: z.string().nullable().optional(),
    sender_state: z.string().nullable().optional(),
    sender_country: z.string().nullable().optional(),
    sender_postalcode: z.string().nullable().optional(),
...
const FlatConsigneeSchema = z.object({
    ...
    consignee_company_name: z.string().nullable().optional(),
    consignee_email: z.string().nullable().optional(),
    consignee_phone: z.string().nullable().optional(),
    consignee_street: z.string().nullable().optional(),
    consignee_number: z.string().nullable().optional(),
    consignee_interior_number: z.string().nullable().optional(),
    consignee_district: z.string().nullable().optional(),
    consignee_city: z.string().nullable().optional(),
    consignee_state: z.string().nullable().optional(),
    consignee_country: z.string().nullable().optional(),
    consignee_postalcode: z.string().nullable().optional(),
    /** Some endpoints return both postalcode (no underscore) and postal_code (with underscore). */
    consignee_postal_code: z.string().nullable().optional(),
...
const ShipmentRecordSchema = FlatSenderSchema.merge(FlatConsigneeSchema).merge(
    z.object({
        ...
        /** Service display name on /shipments/cod. Absent on /shipments. */
        service_name: z.string().optional(),
        name: z.string().optional(),
        carrier_description: z.string().optional(),
        /** Nested origin — present on legacy endpoints, absent on /shipments. */
        origin: z.object({
            name: z.string().optional(),
        ...
        /** Nested destination — present on legacy endpoints, absent on /shipments. */
        ...
        order_row_id: z.union([z.number(), z.string()]).nullable().optional(),
        order_currency: z.string().nullable().optional(),
        generate_order_id: z.union([z.number(), z.string()]).nullable().optional(),
        ...
        return_name: z.string().nullable().optional(),
        return_company_name: z.string().nullable().optional(),
        return_email: z.string().nullable().optional(),
        return_phone: z.string().nullable().optional(),
        return_street: z.string().nullable().optional(),
        return_number: z.string().nullable().optional(),
        return_district: z.string().nullable().optional(),
        return_city: z.string().nullable().optional(),
        return_state: z.string().nullable().optional(),
        return_country: z.string().nullable().optional(),
        return_postalcode: z.string().nullable().optional(),
